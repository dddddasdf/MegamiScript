...
{
    public SkillTypeSort SkillType { get; init; } //스킬 유형
    public int ID { get; init; }              //식별 ID
    public int Rank { get; init; }            //스킬 랭크
    public string Name { get; init; }         //스킬 이름
    public int UseMP { get; init; }           //소모 마나
    public WhichTarget Target { get; init; }  //적용 대상
    public NumberOfTarget? thisTargetNumber { get; init; }   //스킬 대상 개체 수
    public int MinHits { get; init; }         //최소 횟수
    public int MaxHits { get; init; }         //최다 횟수
    public int? Power { get; init; }          //위력: 위력이 필요 하지 않은 스킬일 경우 null
    public int Accuracy { get; init; }        //명중률
    public string Description { get; init; }  //스킬 설명
    public EffectType? AddEffect { get; init; }        //부가 효과: 없을 경우 null
    public int? EffectValue { get; init; }                    //부가 효과의 수치: 없을 경우 null
    /*
    부가 효과의 수치에 대한 세부 설명
    ...
    */
    public TargetStats? EffectStats { get; init; }        //추가 효과(흡수, 회복, 버프, 디버프기)에서 대상이 되는 스탯
}
